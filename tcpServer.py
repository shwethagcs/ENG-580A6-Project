...
import base64
import random
HOST = "192.168.137.225"  # Standard loopback interface address (localhost)
    ...
    def run(self):
        ...
        while True:
            ...
            if(strData=="Read"):
                ...
                humidity=humidity+random.uniform(0.01, 0.25)
                temperature=temperature+random.uniform(0.01, 0.25)
